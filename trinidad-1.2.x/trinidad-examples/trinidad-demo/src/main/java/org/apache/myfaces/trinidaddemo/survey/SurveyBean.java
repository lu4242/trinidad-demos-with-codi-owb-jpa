...
import jsf2jpa.beans.BookingSession;
import jsf2jpa.beans.JpaRequestCycle;
...
public class SurveyBean extends Object implements Serializable
{
  ...
  private void init(String bundleName)
  {
    ...
    /* Check stack is correct (JPA, CDI-OWB)
    ...
    query.setParameter("password", "demo");
    ...
    {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        return ((JpaRequestCycle)facesContext.getApplication().evaluateExpressionGet(
